...
const schema = {
    ...
    cars: {
      ...
      properties: {
        ...
        clientSecret: {
          title: "Client Secret",
          description:
            "Client Secret from https://developer.mercedes-benz.com/",
          type: "string",
          required: true,
        },
        vin: {
        ...
        tankBatteryType: {
          ...
          type: "string",
          description:
            "You can choose between several accessory types for your tank load and/or electric vehicle battery. If 'none' is choosen, only the tank load (for non electric vehicle) or battery level (electric vehicle) will be shown as a battery service within the accessory.",
          oneOf: [
            {
  ...
  layout: [
    ...
    "cars.tankBatteryType",
    {
      ...
      expanded: false,
      orderable: false,
      items: ["cars.manufacturer", "cars.model"],
    },
    {
      key: "cars",
      type: "section",
      ...
      expanded: false,
      orderable: false,
      items: ["cars.maxRange", "cars.polling"],
    },
    {
      key: "cars.token",
      type: "section",
